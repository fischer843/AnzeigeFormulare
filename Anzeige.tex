...
\begin{enumerate}[noitemsep]\setlength\itemsep{0.3em}
	...
	\item Es wird geschrieben, dass die vorgebrachten Vorwürfe bzgl. der Ablaufpläne, Formulare und Entscheide unbegründet seien, dass könne so indirekt auch mittels diverser Entscheiden des Kantonsgerichts und des Bundesgerichts nachgewiesen werden (Absatz 5)
	\item Allgemeine rechtliche Ausführungen, dass die spezielle Förderung ein Bestandteil des kantonalen Bildungsangebots ist und deren Anspruchsnahme vorgängig der Abklärung seitens einer vom Kanton bestimmten Fachstelle bedarf (Absätze 6 u. 7) 
	...
	\item Wiederholung der Aussage aus dem vierten Absatz, dass es keinen Anlass zu Beanstandungen gibt.
\end{enumerate} 
