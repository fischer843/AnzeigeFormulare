...
\begin{enumerate}[noitemsep]\setlength\itemsep{0.3em}
	...
	\item Rechtliche Ausführungen, dass die spezielle Förderung ein Bestandteil des kantonalen Bildungsangebots ist und deren Anspruchsnahme vorgängig der Abklärung seitens einer vom Kanton bestimmten Fachstelle bedarf (Absätze 6 u. 7) 
\end{enumerate} 
