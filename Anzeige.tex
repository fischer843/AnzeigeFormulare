...
\newcommand{\footnoteExt}[1]{
	\footnote{siehe: Abschnitt \ref{#1} ab Seite \pageref{#1}}
}
...
\Rz Der E-Mail\footnoteExt{EmailAnhangAnzeige}vom 06. April 2021 kann klar entnommen werden, dass am 06. April 2021 vom E-Mail-Postfach whistleblowing4bksd.stabrecht@gmail.com eine E-Mail mit Anhängen an die Adresse bksd.stabrecht@bl.ch versendet wurde. Zum ersteren Postfach ist anzumerken, dass ich alleiniger Eigentümer und Bewirtschafter dieses Postfachs bin. Zum Nachweis, wie die E-Mail bei den Empfänger aussieht habe ich diese gleichzeitig an meine (normale) Adresse in K

\Rz Auf Basis der Antwort per E-Mail\footnoteExt{EingangAnzeige}kann als bewiesen gelten, dass erstere E-Mail in der Rechtsabteilung der Bildungs- Kultur- und Sportdirektion (Kurz: BKSD) eingegangen ist und eine Prüfung der eingereichten aufsichtsrechtlichen Anzeige stattfinden soll. Die zweite E-Mail von vom Juristen Herrn Daniel Egli verfasst.
