...
\begin{enumerate}[noitemsep]\setlength\itemsep{0.3em}
	...
	\item dass die Bewilligung der speziellen Förderung an Privatschulen mittels einer Verfügung geschieht, welche durch die Eltern anfechtbar sei (Absatz 10)
	\end{itemize}
