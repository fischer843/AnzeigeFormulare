...
\Rz Am 18. März 2020 gab es aufgrund der Entscheidung des FG-Basel einen weiteren Fachkonvent. Dessen Entscheid kann aus der Aktennotiz\footnoteExt{AktennotizFachkonvent} vom 19. März 2020 entnommen werden. Wie das gesamte Verhalten der Schulleitung Binningen und der Beschluss des oben genannten Fachkonvents juristisch einzustufen ist, kann dem Schreiben\footnoteExt{SchneiderKreuer} des darauf hin von uns eingeschalteten Rechtsanwalt entnommen werden. Es ist besonderer Augenmerk auf den zweiten Absatz des Schreibens zu richten, denn dort ist zu lesen:
\begin{addmargin}[2.5em]{0em}\emph{Meine Mandantschaft hat mir die Situation und den Werdegang ihres Sohnes eingehend geschildert. Ich muss gestehen, dass ich schockiert bin. Ich lasse es vorderhand dahingestellt, inwieweit die Schule ihre Garantenpflicht verletzt hat und welche Konsequenzen diese Kette von gravierenden Ereignissen nach sich ziehen wird.}
\end{addmargin}
...
\begin{enumerate}[noitemsep]\setlength\itemsep{0.3em}
	...
	\item Diverse rechtliche Ausführungen
	\begin{itemize}[noitemsep]\setlength\itemsep{0.3em}
	\item zum Wesenzug einer aufsichtsrechtlichen Anzeige (Absätze 2 u. 3)
	\item dass die spezielle Förderung ein Bestandteil des kantonalen Bildungsangebots ist und deren Anspruchsnahme vorgängig der Abklärung seitens einer vom Kanton bestimmten Fachstelle bedarf (Absätze 6 u. 7) 
	\item Spezifische rechtliche Ausführungen zum Inhalt des § 46 SGS 640, die auf diverse Entscheide des Kantonsgerichts und einem juristischen Aufsatz über das kantonale Bildungsgesetz abgestützt sind (Absatz 8)
	\item dass die Bewilligung der speziellen Förderung an Privatschulen mittels einer Verfügung geschieht, welche durch die Eltern beim Regierungsrat anfechtbar sei (Absatz 10)
	\end{itemize}
	\item Beschreibung über die gelebte Bewilligungspraxis bzgl. der speziellen Förderung an Privatschulen versehen mit Hinweisen auf Verordnung bzgl. des Kindergartens, der Primarschule sowie der Sekundarschule (Absatz 9)
	\item Mitteilung, dass kein Grund gesehen wird, gegen die Abteilung Sonderpädagogik des AVS sowie dem Schulpsychologischen Dienst aufsichtsrechtlich vorgehen zu müssen da die vorgebrachten Vorwürfe bzgl. der Ablaufpläne, Formulare und Entscheide unbegründet seien, dass könne so indirekt auch mittels diverser Entscheiden des Kantonsgerichts und des Bundesgerichts nachgewiesen werden (Absätze 4, 5 u. 10)
\end{enumerate} 

\section{Rechtsprechung des Kantonsgerichts}
\Rz In der Beantwortung der aufsichtsrechtlichen Anzeige werden diverse Entscheide des Kantonsgerichts sowie Bundesgerichts hinsichtlich der speziellen Förderung an Privatschulen aufgeführt. Der zitierte Entscheid des Bundesgericht 2C\_249/2014 ist in Folge eines Rekurs gegen den Entscheid vom 13. November 2013 (KGE 810 13 196) des Kantonsgericht ergangen.

\begin{enumerate}[noitemsep]\setlength\itemsep{0.5em}
	\item 23. März 2005 (KGE 810 04 98; Erwägung 2.c)
	\item 13. November 2013 (KGE 810 13 196) 
	\item 07. Mai 2014 (KGE 810 13 342; Erwägung 5.2) 
	\item 21. August 2019 (KGE 180 18 328; Erwägung 4.3.4)
\end{enumerate}

\Rz Die Nennung der vier Entscheide des  Kantonsgerichts, wobei einer davon indirekt genannt wurde,  kann nur so verstanden werden, dass damit in der Antwort der aufsichtsrechtlichen Anzeige eine gängige Entscheidungspraxis des Kantonsgerichts aufgezeigt werden soll. Inwieweit die geringe Anzahl der genannten Entscheide dafür ausreichend ist, soll nachfolgenden untersucht werden. Bei der Untersuchung der Entscheide, wie ich gleich aufzeigen werde, ist auch der darin jeweils vom Kantonsgericht festgestellte Sachverhalt von elementarer Bedeutung.

\Rz Im Entscheid aus 2005 hatte das Kantonsgericht über die Frage zu entscheiden, ob das kantonale Bildungsgesetz eine genügende Rechtsgrundlage bietet, um eine Gemeinde zur Übernahme der Kosten für die indizierte spezielle Förderung an einer Privatschule eines Primarschülers zu verpflichten. In diesem Entscheid, namentlich im festgestellten Sachverhalt, wird sehr klar ausgeführt, dass sich die Umsetzung der zuvor bewilligte zusätzlichen integrative Förderung als nachteilig für den Schüler erwies. Nach einer daraufhin positiv verlaufenden einwöchigen Probezeit an der Privatschule Z beantragte der Schulpsychologischen Dienst daraufhin für den betroffenen Primarschüler eine Bewilligung einer vorerst einjährige spezielle Förderung an der Privatschule Z. Diese Förderung wurde dann auch vom kantonalen Schulinspektorat bewilligt und die dabei entstehenden Kosten der Gemeinde auferlegt. Gegen die auferlegte Verpflichtung, die Kosten der Privatschule zahlen zu müssen, hat sich zwar die betroffene Gemeinde mittels Beschwerdeverfahrens gewehrt, wurde aber darüber aufgeklärt, dass das Bildungsgesetz für die ihr auferlegte Verpflichtung eine genügende Rechtsgrundlage beinhalte.
